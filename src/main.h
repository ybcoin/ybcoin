...
class CNode;
static const int POW_CUTOFF_HEIGHT = 30001000; // define last POW Block
static const int POS_START_HEIGHT = 30000000; // add POS Switch Start Block
...
boost::filesystem::path OldBlockFilePath();
